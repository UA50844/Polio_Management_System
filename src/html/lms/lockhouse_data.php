                ...
                <div class="nk-content ">
                    <div class="container-fluid">
                        <div class="nk-content-inner">
                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between g-3">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">Lock House Data</h3>
                                        </div>
                                    </div>
                                </div>
                                <!--.nk-block-head -->
                           ...
                           <a class="btn btn-primary d-none d-md-inline-flex" data-bs-toggle="modal" href="#Add"  ><em class="icon ni ni-plus"></em><span>Create Lock-House Sheet </span></a>
</div>
...
include 'connect.php';
    ...
    $stmt = $conn->prepare("select * from lockhouse_data" );
...
?>
                                                      ...
                                                      <tr>
                                                             ...
                                                             <td><?php echo $print['sheet_code']; ?></td>
                                                             <td><?php echo date('d-m-Y ' , strtotime($print['date']));?></td>
                                                            
                                                           

                                                             <td> <?php echo $print['campaign_name']; ?></td>
                                                            ...
                                                            <td>  <div class="dropdown">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-end">
                                                                        <ul class="link-list-opt">
                                                                            <li><a href="html/lms/view_lockhouse_sheet.php?id=<?php echo $print['id'];?>"><em class="icon ni ni-eye"></em><span>View Detail</span></a></li>
    ...
    <div class="modal fade" role="dialog" id="Add">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <a href="html/under_const/index.html" class="close" data-bs-dismiss="modal"><em class="icon ni ni-cross-sm"></em></a>
                <div class="modal-body modal-body-md">
                    <h5 class="title">Add Lock House Sheet</h5>
...
?>">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" name="date" class="form-control mainagent" id="email" placeholder="" >
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label class="form-label" for="email">Campaign Name</label>
                                                        <input type="" name="campaign_name" class="form-control mainagent" id="email" placeholder="" >
                                                    </div>
                                                </div>
                            ...
                            <div class="col-md-12">
                                <ul class="align-center flex-wrap flex-sm-nowrap gx-4 gy-2">
                                    <li>
                                        <input type="submit"  class="btn btn-primary" value="Create" name="create_lockhouse_sheet">
                                    </li>
                                    <li>
