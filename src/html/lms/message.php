...
?>
                                    ...
                                    <div class="nk-chat-profile visible" data-simplebar>
                                        ...
                                        <div class="chat-profile">
                                            <div class="chat-profile-group">
                                                <a href="#" class="chat-profile-head" data-bs-toggle="collapse" data-bs-target="#info-options">
                                                    <h6 class="title overline-title">Student Information</h6>
                                                    <span class="indicator-icon"><em class="icon ni ni-chevron-down"></em></span>
                                                </a>
                                                <div class="chat-profile-body collapse show" id="info-options">
                                                    <div class="chat-profile-body-inner">
                                                        <ul class="chat-profile-options">
                                                            <li>
                                                                <a class="chat-option-link" href="#">
                                                                    <em class="icon icon-circle bg-light ni ni-call"></em>
                                                                    <div>
                                                                        <span class="lead-text">Phone</span>
                                                                        <span class="sub-text">+01-222-364522</span>
                                                                    </div>
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a class="chat-option-link" href="#">
                                                                    <em class="icon icon-circle bg-light ni ni-mail"></em>
                                                                    <div>
                                                                        <span class="lead-text">Email</span>
                                                                        <span class="sub-text">user@gmail.com</span>
                                                                    </div>
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a class="chat-option-link" href="#">
                                                                    <em class="icon icon-circle bg-light ni ni-map-pin"></em>
                                                                    <div>
                                                                        <span class="lead-text">Address</span>
                                                                        <span class="sub-text">1134 Ridder Park Road, San Fransisco, CA 94851</span>
                                                                    </div>
                                                                </a>
                                                            </li>
                                                        </ul>
                ...
                <div class="nk-footer">
                    <div class="container-fluid">
                        <div class="nk-footer-wrap">
                            <div class="nk-footer-copyright"> &copy; 2022 Getsetwebs. Develop by <a href="https://getsetwebs.com/" target="_blank">Getsetwebs</a>
                            </div>
    ...
    <script src="./assets/js/apps/chats.js?ver=3.0.3"></script>
</body>
