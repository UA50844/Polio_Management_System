                                    ...
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            ...
                                            <div class="nk-block-des text-soft">
                                                <p>Welcome to Pakistan Polio Eration program.</p>
                                            </div>
                                                        ...
                                                        <div class="card-inner">
                                                            <div class="card-title-group align-start mb-2">
                                                                <div class="card-title">
                                                                    <h6 class="title">Customer Enrolement</h6>
                                                            ...
                                                            <div class="card-inner pb-0">
                                                                ...
                                                                <div class="data">
                                                                    <div class="data-group">
                                                                        <div class="amount fw-normal">PKR 9,495.20</div>
                                                    ...
                                                    <div class="card">
                                                        <div class="nk-ecwg nk-ecwg3">
                                                            <div class="card-inner pb-0">
                                                                ...
                                                                <div class="data">
                                                                    <div class="data-group">
                                                                        <div class="amount fw-normal">PKR 2,995.81</div>
                                                ...
                                                <div class="card-inner">
                                                    <div class="card-title-group align-start pb-3 g-2">
                                                        <div class="card-title card-title-sm">
                                                            <h6 class="title">Active Customer</h6>
                                                            <p>How do your Customer visited in the time.</p>
                                                        </div>
                                                        <div class="card-tools">
