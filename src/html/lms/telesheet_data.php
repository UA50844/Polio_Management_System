                ...
                <div class="nk-content ">
                    <div class="container-fluid">
                        <div class="nk-content-inner">
                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between g-3">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">Telesheet Data</h3>
                                        </div>
                                    </div>
                                </div>
                                <!--.nk-block-head -->
                           ...
                           <a class="btn btn-primary d-none d-md-inline-flex"  href="html/lms/create_telesheet.php" ><em class="icon ni ni-plus"></em><span>Create Telesheet </span></a>
</div>
...
include 'connect.php';
    ...
    $stmt = $conn->prepare("select * from telesheet_data" );
...
?>
                                                      ...
                                                      <tr>
                                                            ...
                                                            <td><?php echo $print['total_no_of_kids']; ?></td>
                                                            ...
                                                            <td>  <div class="dropdown">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-end">
                                                                        <ul class="link-list-opt">
                                                                            <li><a href="html/lms/view_telesheet.php?id=<?php echo $print['id'];?>"><em class="icon ni ni-eye"></em><span>View Detail</span></a></li>
