                ...
                <div class="nk-content ">
                    <div class="container-fluid">
                        <div class="nk-content-inner">
                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between g-3">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">NA / R List Data</h3>
                                        </div>
                                    </div>
                                </div>
                                <!--.nk-block-head -->
                           ...
                           <a class="btn btn-primary d-none d-md-inline-flex" data-bs-toggle="modal" href="#Add"  ><em class="icon ni ni-plus"></em><span>Create NA/R Sheet </span></a>
</div>
...
include 'connect.php';
    ...
    $stmt = $conn->prepare("select * from nar_list_data" );
...
?>
                                                      ...
                                                      <tr>
                                                             ...
                                                             <td> <?php echo $print['sheet_name']; ?></td>
                                                            ...
                                                            <td>  <div class="dropdown">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-end">
                                                                        <ul class="link-list-opt">
                                                                            <li><a href="html/lms/view_narlist_sheet.php?id=<?php echo $print['id'];?>"><em class="icon ni ni-eye"></em><span>View Detail</span></a></li>
...
?>">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="" name="sheet_name" class="form-control mainagent" id="email" placeholder="" >
                                                    </div>
                                                </div>
                            ...
                            <div class="col-md-12">
                                <ul class="align-center flex-wrap flex-sm-nowrap gx-4 gy-2">
                                    <li>
                                        <input type="submit"  class="btn btn-primary" value="Create" name="create_nar_sheet">
                                    </li>
                                    <li>
